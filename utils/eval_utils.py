...
def generate_corrected_gt_json(gt_dir, results_dir, max_bboxes=20, model_name="test"):
    ...
    json.dump(new_json, open(f"../ground_truths/mod_gt_{model_name}_annotations.json", "w"))
